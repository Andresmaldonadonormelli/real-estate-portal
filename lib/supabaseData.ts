...
export const PROPERTY_FIELDS='id,address,city,state,zip,mortgage_balance,property_type,purchase_price,purchase_date,monthly_mortgage_payment,mortgage_interest_rate,mortgage_term_years,mortgage_principal_interest_payment,mortgage_escrow_amount,mortgage_pmi_amount,management_fee_percent,image_path,mortgage_start_date,mortgage_recurring_enabled,archived_at,created_at';
...
export const TRANSACTION_FIELDS='id,property_id,unit_id,transaction_date,type,category,description,payee_source,amount,notes,import_key,source,source_institution,source_account_mask,source_connection_status,status,confirmed_at,archived_at,created_at,needs_review,is_new_import,import_acknowledged_at,receipt_path,supporting_document_id';
