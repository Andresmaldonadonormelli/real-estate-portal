...
export const TRANSACTION_FIELDS='id,property_id,unit_id,transaction_date,type,category,description,payee_source,amount,notes,import_key,source,source_institution,source_account_mask,source_connection_status,status,confirmed_at,archived_at,created_at,needs_review,receipt_path,supporting_document_id';
