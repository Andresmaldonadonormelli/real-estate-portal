...
function loanModel(property:Property,_transactions:Tx[],extra:number){
  ...
  const remaining=Math.max(1,term*12-elapsed);
  ...
  return{balance,rate,payment,remaining,baseline:schedule(0),scenario:schedule(extra)};
}
