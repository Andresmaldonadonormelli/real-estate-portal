    ...
    {loading?<PageSkeleton variant="dashboard"/>:<>
      ...
      <main className="pulse-dashboard-main">
        <section className="pulse-performance-open">
          ...
          <div className="pulse-cash-summary"><strong className="amount-cash-flow">{formatCurrency(displayedCashFlow?.cashFlow||0)}</strong><div className="pulse-cash-breakdown"><span><b>Income</b><strong className="amount-positive">{formatCurrency(displayedCashFlow?.income||0)}</strong></span><span><b>Expenses</b><strong className="amount-negative">{formatCurrency(displayedCashFlow?.cashExpenses||0)}</strong></span></div></div>
